...
(
    ...
    KEY `fk_Cupcake_Buttom1_idx` (`buttomId`),
    KEY `fk_cupcake_order1_idx` (`orderId`),
    CONSTRAINT `fk_Cupcake_Buttom1` FOREIGN KEY (`buttomId`) REFERENCES `bottom` (`id`),
...
/*!40000 ALTER TABLE `order`
    DISABLE KEYS */;
INSERT INTO `order`
VALUES ('2023-03-28 00:23:15', 1, 10),
       ('2023-03-28 00:29:04', 2, 10),
       ('2023-03-28 00:30:11', 3, 10),
       ('2023-03-28 00:33:41', 4, 32),
       ('2023-03-28 01:00:59', 5, 20),
       ('2023-03-28 01:03:46', 6, 20),
       ('2023-03-28 01:04:39', 7, 10),
       ('2023-03-28 01:09:34', 8, 10),
       ('2023-03-28 01:11:00', 9, 10),
       ('2023-03-28 01:13:02', 10, 10),
       ('2023-03-28 01:14:55', 11, 10),
       ('2023-03-28 01:15:35', 12, 10),
       ('2023-03-28 02:12:05', 13, 11),
       ('2023-03-28 02:14:25', 14, 16),
       ('2023-03-28 02:17:21', 15, 11);
/*!40000 ALTER TABLE `order`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-03-28  2:30:01
